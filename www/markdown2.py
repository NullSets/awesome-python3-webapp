...
Module usage:
    ...
    >>> import markdown2.py
    >>> markdown2.py.markdown("*boo!*")  # or use `html = markdown_path(PATH)`
    u'<p><em>boo!</em></p>\n'
...
<https://github.com/trentm/python-markdown2.py/wiki/Extras>.
"""
...
see <https://github.com/trentm/python-markdown2.py/wiki/Extras> for details):
...
* metadata: Extract metadata from a leading '---'-fenced block.
  See <https://github.com/trentm/python-markdown2.py/issues/77> for details.
...
class Markdown(object):
    ...
    def _do_links(self, text):
        ...
        """
        MAX_LINK_TEXT_SENTINEL = 3000  # markdown2.py issue 24
    ...
    def _do_smart_punctuation(self, text):
        ...
        support here and
        <http://code.google.com/p/python-markdown2.py/issues/detail?id=42> for a
...
def main(argv=None):
    ...
    parser = optparse.OptionParser(prog="markdown2.py", usage=usage,
